...
[![x-cmd/install — evo Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/evo.svg?lang=zh)](https://x-cmd.com/install/evo)
...
- **上游仓库**: <https://github.com/evo-hq/evo>
- **官网**: <https://evo-hq.com>
- **许可证**: Apache-2.0
...
- **Star**: 1,459 · **Fork**: 112 · **开放 issue**: 37 · **贡献者**: 4

## 累计统计

- **发布数**: 59 · **已合并 PR**: 40 · **开放 PR**: 21 · **已关闭 issue**: 21 · **开放 issue**: 16 · **提交数**: 458

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-24 | 0 | 0 | 13 | 0 | 7 | 0 |
| last60d | 2026-07-25 | 0 | 0 | 14 | 0 | 7 | 0 |
| 90d | 2026-06-25 | 7 | 3 | 17 | 0 | 8 | 14 |
| last180d | 2026-03-27 | 59 | 40 | 21 | 21 | 16 | 429 |
| 360d | 2025-09-28 | 59 | 40 | 21 | 21 | 16 | 429 |
| last720d | 2024-10-03 | 59 | 40 | 21 | 21 | 16 | 458 |
...
evo 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `evo` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/evo.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T05:30:05Z._
